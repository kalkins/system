...
tags = {
    names  = { "main", "www", "mscore", "div", "work"},
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "oslash",  awful.tag.viewnext       ),
    ...
    awful.key({ modkey,           }, "oslash",     function () awful.tag.incmwfact(-0.05)    end),
    awful.key({ modkey, "Shift"   }, "oslash",     function () awful.tag.incnmaster( 1)      end),
    awful.key({ modkey, "Shift"   }, "j",     function () awful.tag.incnmaster(-1)      end),
    awful.key({ modkey, "Control" }, "oslash",     function () awful.tag.incncol( 1)         end),
