...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__20316_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__20316_SHARP_),cljs.core.second.call(null,p1__20316_SHARP_));
}),cljs.core.map.call(null,(function (p1__20317_SHARP_,p2__20318_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__20317_SHARP_,p2__20318_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__20320 = cljs.core.first.call(null,path_pieces);
switch (G__20320) {
case "":
...
var G__20323 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__20323) {
case "cwd":
...
var G__20326 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__20326)){
return path_pieces;
} else {
if(cljs.core._EQ_.call(null,"..",G__20326)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__20326)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
...
while(true){
var vec__20331 = remaining_path;
var curr = cljs.core.nth.call(null,vec__20331,(0),null);
var remainder = cljs.core.nthnext.call(null,vec__20331,(1));
var pred__20332 = cljs.core._EQ_;
var expr__20333 = curr;
if(cljs.core.truth_(pred__20332.call(null,null,expr__20333))){
return result;
} else {
if(cljs.core.truth_(pred__20332.call(null,"",expr__20333))){
var G__20335 = result;
var G__20336 = remainder;
result = G__20335;
remaining_path = G__20336;
continue;
} else {
if(cljs.core.truth_(pred__20332.call(null,".",expr__20333))){
var G__20337 = result;
...
result = G__20337;
remaining_path = G__20338;
continue;
} else {
if(cljs.core.truth_(pred__20332.call(null,"..",expr__20333))){
var G__20339 = pathetic.core.up_dir.call(null,result);
var G__20340 = remainder;
result = G__20339;
remaining_path = G__20340;
continue;
} else {
var G__20341 = cljs.core.conj.call(null,result,curr);
var G__20342 = remainder;
result = G__20341;
remaining_path = G__20342;
continue;
}
}
}
...
var pred__20346 = cljs.core._EQ_;
var expr__20347 = curr;
if(cljs.core.truth_(pred__20346.call(null,null,expr__20347))){
return suffix;
} else {
if(cljs.core.truth_(pred__20346.call(null,"",expr__20347))){
var G__20349 = suffix;
var G__20350 = cljs.core.rest.call(null,remainder);
suffix = G__20349;
remainder = G__20350;
continue;
} else {
if(cljs.core.truth_(pred__20346.call(null,".",expr__20347))){
var G__20351 = suffix;
var G__20352 = cljs.core.rest.call(null,remainder);
suffix = G__20351;
remainder = G__20352;
continue;
} else {
if(cljs.core.truth_(pred__20346.call(null,"..",expr__20347))){
var G__20353 = cljs.core.conj.call(null,suffix,"..");
var G__20354 = cljs.core.rest.call(null,remainder);
suffix = G__20353;
remainder = G__20354;
continue;
} else {
var G__20355 = cljs.core.conj.call(null,suffix,curr);
var G__20356 = cljs.core.rest.call(null,remainder);
suffix = G__20355;
remainder = G__20356;
continue;
}
...
var vec__20358 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20358,(0),null);
var path = cljs.core.nth.call(null,vec__20358,(1),null);
var post_path = cljs.core.nth.call(null,vec__20358,(2),null);
...
var vec__20360 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20360,(0),null);
var path = cljs.core.nth.call(null,vec__20360,(1),null);
var post_path = cljs.core.nth.call(null,vec__20360,(2),null);
