...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__33960_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__33960_SHARP_),cljs.core.second.call(null,p1__33960_SHARP_));
}),cljs.core.map.call(null,(function (p1__33961_SHARP_,p2__33962_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__33961_SHARP_,p2__33962_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__33964 = cljs.core.first.call(null,path_pieces);
switch (G__33964) {
case "":
...
var G__33967 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__33967) {
case "cwd":
...
var G__33970 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__33970)){
return path_pieces;
} else {
if(cljs.core._EQ_.call(null,"..",G__33970)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__33970)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
...
while(true){
var vec__33975 = remaining_path;
var curr = cljs.core.nth.call(null,vec__33975,(0),null);
var remainder = cljs.core.nthnext.call(null,vec__33975,(1));
var pred__33976 = cljs.core._EQ_;
var expr__33977 = curr;
if(cljs.core.truth_(pred__33976.call(null,null,expr__33977))){
return result;
} else {
if(cljs.core.truth_(pred__33976.call(null,"",expr__33977))){
var G__33979 = result;
var G__33980 = remainder;
result = G__33979;
remaining_path = G__33980;
continue;
} else {
if(cljs.core.truth_(pred__33976.call(null,".",expr__33977))){
var G__33981 = result;
var G__33982 = remainder;
result = G__33981;
remaining_path = G__33982;
continue;
} else {
if(cljs.core.truth_(pred__33976.call(null,"..",expr__33977))){
var G__33983 = pathetic.core.up_dir.call(null,result);
var G__33984 = remainder;
result = G__33983;
remaining_path = G__33984;
continue;
} else {
var G__33985 = cljs.core.conj.call(null,result,curr);
var G__33986 = remainder;
result = G__33985;
remaining_path = G__33986;
continue;
}
}
}
...
var expr__33991 = curr;
if(cljs.core.truth_(pred__33990.call(null,null,expr__33991))){
return suffix;
} else {
if(cljs.core.truth_(pred__33990.call(null,"",expr__33991))){
var G__33993 = suffix;
var G__33994 = cljs.core.rest.call(null,remainder);
suffix = G__33993;
remainder = G__33994;
continue;
} else {
if(cljs.core.truth_(pred__33990.call(null,".",expr__33991))){
var G__33995 = suffix;
var G__33996 = cljs.core.rest.call(null,remainder);
suffix = G__33995;
remainder = G__33996;
continue;
} else {
if(cljs.core.truth_(pred__33990.call(null,"..",expr__33991))){
var G__33997 = cljs.core.conj.call(null,suffix,"..");
var G__33998 = cljs.core.rest.call(null,remainder);
suffix = G__33997;
remainder = G__33998;
continue;
} else {
var G__33999 = cljs.core.conj.call(null,suffix,curr);
var G__34000 = cljs.core.rest.call(null,remainder);
suffix = G__33999;
remainder = G__34000;
continue;
}
...
var vec__34002 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__34002,(0),null);
var path = cljs.core.nth.call(null,vec__34002,(1),null);
var post_path = cljs.core.nth.call(null,vec__34002,(2),null);
...
var vec__34004 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__34004,(0),null);
var path = cljs.core.nth.call(null,vec__34004,(1),null);
var post_path = cljs.core.nth.call(null,vec__34004,(2),null);
